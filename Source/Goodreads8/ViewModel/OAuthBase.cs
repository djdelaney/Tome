...
namespace Goodreads8.ViewModel
{
    public class OAuthBase
    {
        ...
        private string ComputeHash(MacAlgorithmProvider hashAlgorithm, CryptographicKey key, string data)
        {
            ...
            IBuffer hashBytes = CryptographicEngine.Sign(key, dataBuffer);

            return CryptographicBuffer.EncodeToBase64String(hashBytes);
        }
        ...
        /// <returns>A base64 string of the hash value</returns>
        public string GenerateSignatureUsingHash(string signatureBase, MacAlgorithmProvider hash, CryptographicKey key)
        {
